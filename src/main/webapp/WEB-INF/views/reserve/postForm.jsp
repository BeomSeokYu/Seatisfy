			...
			<div class="col-lg-9">
				<form:form action="/reserve/add" method="post" modelAttribute="postDTO" id="postFrm">
					...
					<fieldset class="border p-2 rounded mb-5">
						...
						<form:input path="ptitle" id="ptitle" class="form-control rounded"/>
					...
					<fieldset class="border p-2 rounded mb-5">
						...
						<form:input path="place" id="place" class="form-control rounded"/>
						<div><form:errors path="place" cssStyle="color:red;"/></div>
						
						<label for="address" class="form-label">주소</label>
						<form:input path="address" id="address" class="form-control rounded"/>
					...
					<fieldset class="border p-2 rounded mb-5">
						...
						<div><div class="badge bg-success mb-3">가로 세로 배치를 입력 후 비울 곳을 클릭해 제외시키세요</div></div>
						<div class="mb-3">
							<input id="seatX" type="number" min="1" max="20" value="10" class="rounded"/>
							X <input id="seatY" type="number" min="1" max="20" value="10" class="rounded"/>
							<button class="btn btn-sm btn-outline-success" id="seatTableBtn" type="button">만들기</button>
						</div>
						...
						<form:input id="sdate" path="startdate" type="datetime-local" class="form-control rounded"/>
						<div><form:errors path="startdate" cssStyle="color:red;"/></div>
						
						<label for="edate" class="form-label mt-3">종료일</label>
						<form:input id="edate" path="enddate" type="datetime-local" class="form-control rounded"/>
